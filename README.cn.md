...
合计: **1,940,163** 行代码（覆盖前 5 种语言、共 **7633** 个文件）。
...
- **Star**: 32,841 · **Fork**: 3,371 · **开放 issue**: 10,899 · **贡献者**: 912

## 累计统计

- **发布数**: 249 · **已合并 PR**: 12940 · **开放 PR**: 184 · **已关闭 issue**: 9992 · **开放 issue**: 907 · **提交数**: 28352
...
_数据快照: `data/card/260911.yml` · 2026-09-11T05:33:29Z._
