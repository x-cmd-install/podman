...
合计: **1,940,331** 行代码（覆盖前 5 种语言、共 **7635** 个文件）。
...
- **Star**: 32,846 · **Fork**: 3,371 · **开放 issue**: 10,904 · **贡献者**: 914

## 累计统计

- **发布数**: 249 · **已合并 PR**: 12944 · **开放 PR**: 184 · **已关闭 issue**: 10001 · **开放 issue**: 903 · **提交数**: 28358
...
在 [repology.org](https://repology.org/project/podman) 上共有 **466** 个发行版报告此项目。**40** 个 ✅ 已是最新上游版本，**276** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260913.yml` · 2026-09-13T05:43:31Z._
