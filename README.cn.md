...
[![x-cmd/install — podman Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/podman.svg?lang=zh)](https://x-cmd.com/install/podman)
...
合计: **1,943,327** 行代码（覆盖前 5 种语言、共 **7651** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 1,645,632 | 295,084 | 201,951 | 7340 |
...
- **最新版本**: `v5.8.7` (2026-09-16)
- **最近提交**: 2026-09-22
- **Release 含资产**: 9 个

## 流行度

- **Star**: 32,916 · **Fork**: 3,384 · **开放 issue**: 10,920 · **贡献者**: 927

## 累计统计

- **发布数**: 251 · **已合并 PR**: 12986 · **开放 PR**: 147 · **已关闭 issue**: 10044 · **开放 issue**: 876 · **提交数**: 28441
...
| 90d | 2026-06-25 | 10 | 0 | 0 | 0 | 0 | 0 |
| last180d | 2026-03-27 | 14 | 0 | 0 | 0 | 0 | 0 |
| 360d | 2025-09-28 | 22 | 0 | 0 | 0 | 0 | 0 |
| last720d | 2024-10-03 | 45 | 0 | 0 | 0 | 0 | 0 |
...
_数据快照: `data/card/260923.yml` · 2026-09-23T05:54:51Z._
