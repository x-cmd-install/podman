...
[![x-cmd/install — podman Code Quality Monitoring Repo Card](https://repo.x-cmd.io/podman.svg?lang=zh)](https://x-cmd.com/install/podman)
...
合计: **1,943,128** 行代码（覆盖前 5 种语言、共 **7648** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 1,645,453 | 294,924 | 201,884 | 7337 |
...
- **Star**: 32,898 · **Fork**: 3,380 · **开放 issue**: 10,915 · **贡献者**: 924

## 累计统计

- **发布数**: 251 · **已合并 PR**: 12973 · **开放 PR**: 156 · **已关闭 issue**: 10037 · **开放 issue**: 878 · **提交数**: 28413
...
_数据快照: `data/card/260920.yml` · 2026-09-20T05:47:56Z._
